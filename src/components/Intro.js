          ...
          <div className="container w-full px-0 mx-auto z-30 relative">
            <div className="flex flex-col pt-8 md:pt-16">
              ...
              <div className="max-w-6xl md:text-xl text-lg font-medium !mb-8 md:w-full w-4/5  !leading-[110%] tracking-tight opacity-60">
                ...
                stretching across Mesopotamia and Anatolia. They left behind
                over 25,000 clay tablets at the site of ancient
                ...
                between husbands and wives. Each tablet records a moment in the
                life of real people:
                ...
                Their world was connected by caravans and sealed with trust—but
                also plagued by debt, distance, and disputes. Through their
                tablets, we glimpse negotiations, betrayals, reconciliations,
                and even rebellion. One family's rift could destabilize an
                entire economic alliance.
                <br />
                <br />
                ...
                <br />
                <br />
                <span className="font-bold">The Deep Past Challenge</span>{" "}
                invites you to build machine translation systems that can unlock
                this archive. Every word you help translate brings us closer to
                understanding how ancient trade, law, family, and technology
                once intertwined.
                <br />
                <br />
