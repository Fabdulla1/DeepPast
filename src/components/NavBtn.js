...
const NavBtn = ({ text, subtitle, to }) => {
  return (
    <Link
      to={to}
      className="group inline-block no-underline rounded-xl bg-black/40 dark:bg-black/60 px-8 py-4 border-2 border-gray-600 hover:bg-black/60 dark:hover:bg-black/40 transition ease-in-out duration-500"
    >
